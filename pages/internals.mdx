...
Each pixel can produce a colour using different combinations of the colours red, green and blue, known as _RGB_.
...
Each image (or frame, when referring to moving content) is represented using a long list of these 24 bit numbers.
The screen then uses this list to display the image, usually from top left to bottom right.
Images represented in this fashion are known as _raster images_.
