...
This means that all the crystals are aligned so that they are parallel (_ViewSonic, 2022_ [^3]). This allow for an IPS display to be extremely colour accurate.
An advantage of an IPS display is that they have a low response time (_Harding, 2020_ [^4]).
