...
On this page we will be having a look at the different types of monitor connectors.
...
The first connector that we will be looking at is Video Graphics Adapter (VGA).
This cable was first introduced by IBM in 1987.
The disadvantage of VGA is that it can only handle a resolution of 640 x 480 and only at a refresh rate of 60hz (HP, 2022 [^1]).
The low resolution and refresh rate is due to VGA's use of analogue signals (History computer staff, 2022 [^2]).

<Image src="./vga.png" />
<ImageCredit>Porter Computers [^3]</ImageCredit>

## DVI

The first DVI cable came into use in 1999.
DVI stands for Digital Visual Interface and is capable of resolutions up to 1920 x 1080 and a refresh rate of up to 144hz.
This is a major advantage as it allows for a smoother and more attractive viewing experience.
There is also three different types of DVI cables DVI-A (analogue only), DVI-D (digital only) and DVI-I (both), (History computer staff, 2022 [^2]).

<Image src="dvi.png" />
<ImageCredit>Cablematic [^4]</ImageCredit>

## HDMI

HDMI cables were first made in 2002 (HDMI, 2022 [^5]).
HDMI stands for High Definition Multimedia Interface.
The advantage of HDMI cables is that they are capable of transferring high quality audio and video and resolutions up to 8k and refresh rated of 240hz which will lead to abetter user experience (Techreviewer, 2022 [^6]).

<Image src="hdmi.png" />
<ImageCredit>Star Tech [^7]</ImageCredit>
...
[^2]: [History Computer Staff, (2021). “_DVI vs VGA: Full Comparison”_, History Computer.](https://history-computer.com/dvi-vs-vga/)
